          ...
          <table className="table table-bordered">
            ...
            <tbody>
              <tr>
                <td>
                  <div className="flex items-center gap-base">
                    <Image src={product1} alt="Wireless Earbuds" className="size-9 rounded-md" />
                    <div>
              ...
              <tr>
                <td>
                  <div className="flex items-center gap-base">
                    <Image src={product2} alt="Smart Watch" className="size-9 rounded-md" />
                    <div>
                      <h5 className="text-default-800 font-medium mb-1.25">
                        <Link href="/apps/ecommerce/product-details" className="hover:text-primary">
                          Smart Watch
              ...
              <tr>
                <td>
                  <div className="flex items-center gap-base">
                    <Image src={product3} alt="Gaming Mouse" className="size-9 rounded-md" />
                    <div>
                      <h5 className="text-default-800 font-medium mb-1.25">
                        <Link href="/apps/ecommerce/product-details" className="hover:text-primary">
                          Gaming Mouse
