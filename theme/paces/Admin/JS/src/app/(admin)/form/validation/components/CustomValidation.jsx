        ...
        <form id="tailwindValidationForm" className="grid md:grid-cols-12 grid-cols-1 gap-4" noValidate onSubmit={handleSubmit(onSubmit)}>
          <div className="md:col-span-4">
            ...
            <div className="relative">
              <input
                ...
                id="firstName"
                defaultValue="John"
                className={cn('input-field form-input', errors.firstName ? '!border-danger' : '!border-success')}
                {...register('firstName', {
                  required: true,
                })}
              />
          ...
          <div className="md:col-span-4">
            ...
            <div className="relative">
              <input
                ...
                id="lastName"
                defaultValue="Doe"
                className={cn('input-field form-input', errors.lastName ? '!border-danger' : '!border-success')}
                {...register('lastName', {
                  required: true,
                })}
              />
          ...
          <div className="md:col-span-4">
            ...
            <div className="relative input-group">
              ...
              <input
                ...
                className={cn('input-field form-input', errors.username ? '!border-danger' : '!border-success')}
                {...register('username', {
                  required: true,
                  minLength: 3,
                })}
          ...
          <div className="md:col-span-6">
            ...
            <div className="relative">
              <input
                ...
                className={cn('input-field form-input', errors.city ? '!border-danger' : '!border-success')}
                {...register('city', {
                  required: true,
                })}
              />
          ...
          <div className="md:col-span-3">
            ...
            <div className="relative">
              <select
                id="state"
                className={cn('input-field form-input', errors.state ? '!border-danger' : '!border-success')}
                {...register('state', {
                  required: true,
                })}
              >
          ...
          <div className="md:col-span-3">
            ...
            <div className="relative">
              <input
                ...
                id="zip"
                placeholder="94107"
                className={cn('input-field form-input', errors.zip ? '!border-danger' : '!border-success')}
                {...register('zip', {
                  required: true,
                  pattern: /^\d{5}$/,
                })}
