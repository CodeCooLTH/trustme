...
import { CategoryScale, ChartComponentLike, ChartConfiguration, Chart as ChartJS, ChartOptions, Decimation, Legend, LinearScale, SubTitle, Title, Tooltip } from 'chart.js'
