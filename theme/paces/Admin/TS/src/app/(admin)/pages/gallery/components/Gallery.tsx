...
const photos = [
  { src: img1.src, width: 640, height: 427, category: 'machine-learning' },
  { src: img2.src, width: 640, height: 360, category: 'computer-vision' },
  { src: img3.src, width: 640, height: 854, category: 'nlp' },
  { src: img4.src, width: 640, height: 640, category: 'robotics' },
  { src: img5.src, width: 640, height: 960, category: 'machine-learning' },
  { src: img6.src, width: 640, height: 800, category: 'machine-learning' },
  { src: img7.src, width: 640, height: 425, category: 'computer-vision' },
  { src: img8.src, width: 640, height: 480, category: 'nlp' },
  { src: img9.src, width: 640, height: 960, category: 'robotics' },
  { src: img10.src, width: 640, height: 962, category: 'robotics' },
  { src: img11.src, width: 640, height: 427, category: 'machine-learning' },
  { src: img12.src, width: 640, height: 359, category: 'computer-vision' },
  { src: img13.src, width: 640, height: 359, category: 'nlp' },
  { src: img14.src, width: 640, height: 960, category: 'nlp' },
].map((item) => ({
  ...item,
