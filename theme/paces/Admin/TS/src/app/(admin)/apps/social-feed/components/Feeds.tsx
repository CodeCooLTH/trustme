  ...
  return (
    <CommonPostCard image={user10} name="Jeremy Tomlinson" time="about 2 minutes ago" description="Story based around the idea of time lapse, animation to post soon!">
      <div className="grid grid-cols-2 gap-1.5">
        <Image src={gallery10} className="h-full rounded" style={{ aspectRatio: '3/4', objectFit: 'cover' }} alt="Tall Image" />

        <div className="flex flex-col gap-1.5">
          <Image src={gallery2} className="rounded" style={{ aspectRatio: ' 4/3', objectFit: 'cover' }} alt="Top Right" />

          <Image src={gallery3} className="rounded" style={{ aspectRatio: '4/3', objectFit: 'cover' }} alt="Bottom Right" />
        </div>
      </div>
    </CommonPostCard>
  )
