...
import { DealStatType, dealStatData } from './components/data'
...
const DealStatisticCard = ({ stat }: { stat: DealStatType }) => {
        ...
        <div className="flex">
          <div className="flex-1">
            ...
            <div className="bg-default-100 h-1.25 w-full rounded-full">
              <div className={cn('h-1.25 rounded-s-full', className)} role="progressbar" style={{ width: `${progress}%` }} aria-valuenow={progress} aria-valuemin={0} aria-valuemax={100} />
            </div>
          </div>
        </div>
      </div>
