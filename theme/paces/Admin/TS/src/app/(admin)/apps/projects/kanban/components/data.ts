...
export type KanbanTaskType = {
  ...
  title: string
  assignee: { name: string; avatar: StaticImageData }
...
export const KanbanTaskData: KanbanTaskType[] = [
  {
    ...
    assignee: { name: 'Ava Mitchell', avatar: user5 },
  ...
  },
  {
    ...
    assignee: { name: 'Mia Johnson', avatar: user8 },
  ...
  },
  {
    ...
    assignee: { name: 'Emma Scott', avatar: user9 },
  ...
  },
  {
    ...
    assignee: { name: 'Noah Parker', avatar: user3 },
  ...
  },
  {
    ...
    assignee: { name: 'Lucas Martin', avatar: user7 },
  ...
  },
  {
    ...
    assignee: { name: 'Sophia Wilson', avatar: user4 },
  ...
  },
  {
    ...
    assignee: { name: 'Hannah Green', avatar: user7 },
  ...
  },
  {
    ...
    assignee: { name: 'Evelyn Clark', avatar: user9 },
  ...
  },
  {
    ...
    assignee: { name: 'Benjamin Hill', avatar: user10 },
...

  {
    ...
    assignee: { name: 'Andrew Carter', avatar: user6 },
  ...
  },
  {
    ...
    assignee: { name: 'Logan Brooks', avatar: user7 },
  ...
  },
  {
    ...
    assignee: { name: 'Mark Evans', avatar: user1 },
...

  {
    ...
    assignee: { name: 'Harper Lee', avatar: user3 },
  ...
  },
  {
    ...
    assignee: { name: 'Jacob Miller', avatar: user5 },
