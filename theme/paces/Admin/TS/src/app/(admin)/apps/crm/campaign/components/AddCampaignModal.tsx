          ...
          <div className="overflow-y-auto card-body">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Flatpickr type="date" options={{ defaultDate: 'today', dateFormat: 'd M, Y' }} className="form-input" id="launchDate" />
              </div>
              <div>
                <label htmlFor="launchTime" className="form-label">
                  Launch Time
                </label>
                <Flatpickr type="time" options={{ defaultDate: 'today', enableTime: true, noCalendar: true }} className="form-input" id="launchTime" />
              </div>
            </div>
          </div>
