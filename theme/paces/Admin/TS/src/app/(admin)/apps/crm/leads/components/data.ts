...
export const leadData: LeadType[] = [
  {
    ...
    amount: '$150000',
    tag: { label: 'Cloud', className: 'bg-info/15 text-info' },
  ...
  },
  {
    ...
    amount: '$98500',
    tag: { label: 'AI', className: 'bg-warning/15 text-warning' },
  ...
  },
  {
    ...
    amount: '$120000',
    tag: { label: 'Cloud', className: 'bg-success/15 text-success' },
  ...
  },
  {
    ...
    amount: '$65000',
    tag: { label: 'Design', className: 'bg-danger/15 text-danger' },
  ...
  },
  {
    ...
    amount: '$142000',
    tag: { label: 'VR', className: 'bg-secondary/15 text-secondary' },
  ...
  },
  {
    ...
    amount: '$75500',
    tag: { label: 'Streaming', className: 'bg-info/15 text-info' },
  ...
  },
  {
    ...
    amount: '$110250',
    tag: { label: 'EV', className: 'bg-dark/15 text-dark' },
  ...
  },
  {
    ...
    amount: '$87000',
    tag: { label: 'Travel', className: 'bg-danger/15 text-danger' },
  ...
  },
  {
    ...
    amount: '$332000',
    tag: { label: 'Collaboration', className: 'bg-info/15 text-info' },
  ...
  },
  {
    ...
    phone: '+46 31 123 456',
    amount: '$917000',
    tag: { label: 'Music', className: 'bg-success/15 text-success' },
