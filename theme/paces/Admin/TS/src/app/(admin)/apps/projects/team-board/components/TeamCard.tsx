...
const TeamCard = ({ team, index }: { team: TeamType; index: number }) => {
  return (
      ...
      <div className="card-body flex justify-between flex-col h-full">
        ...
        <div className="mb-5">
          ...
          <div className="bg-default-100 flex h-1.25 w-full overflow-hidden rounded-full" role="progressbar" aria-valuenow={team.progress.value} aria-valuemin={0} aria-valuemax={100}>
            <div className="bg-primary flex flex-col justify-center overflow-hidden rounded-full rounded-e-none text-center text-xs whitespace-nowrap text-white transition duration-500" style={{ width: `${team.progress.value}%` }}></div>
          </div>
        </div>
