        ...
        <SimpleBar className="card-body h-full">
          ...
          <div>
            {profileMainMenuData.map((item, idx) => (
              <Link key={idx} href={item.href} className={cn('flex w-full items-center gap-2.25 rounded px-3 py-2 font-semibold hover:bg-default-100 focus:bg-default-100', { 'active bg-default-100': idx === 0 })}>
