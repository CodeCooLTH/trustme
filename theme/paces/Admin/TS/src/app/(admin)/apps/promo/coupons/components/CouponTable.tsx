  ...
  const columns = [
    {
      id: 'select',
      size: 45,
      header: ({ table }: { table: TableType<CouponType> }) => <input type="checkbox" className="form-checkbox form-checkbox-light size-4.5" checked={table.getIsAllRowsSelected()} onChange={table.getToggleAllRowsSelectedHandler()} />,
      cell: ({ row }: { row: TableRow<CouponType> }) => <input type="checkbox" className="form-checkbox form-checkbox-light size-4.5" checked={row.getIsSelected()} onChange={row.getToggleSelectedHandler()} />,
    },
      ...
      <div className="card-header">
        ...
        <div className="flex flex-wrap items-center gap-3 md:flex-nowrap">
          ...
          <div className="input-icon-group">
            ...
            <select className="form-select" value={(table.getColumn('discountType')?.getFilterValue() as string) ?? 'All'} onChange={(e) => table.getColumn('discountType')?.setFilterValue(e.target.value === 'All' ? undefined : e.target.value)}>
              ...
              <div className="card-body">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Flatpickr options={{ dateFormat: 'd M, Y', defaultDate: 'today' }} className="form-input flatpickr-input" name="start_date" placeholder="Select start date" required readOnly />
                  </div>
                  <div>
                    <label className="form-label">
                      End Date
                    ...
                    <Flatpickr options={{ dateFormat: 'd M, Y', defaultDate: 'today' }} className="form-input flatpickr-input" name="end_date" placeholder="Select end date" required readOnly />
                  </div>
                  <div>
