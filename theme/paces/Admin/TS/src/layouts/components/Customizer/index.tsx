...
const Customizer = () => {
  ...
  return (
    <div>
      ...
      >
        <div className="bg-primary text-default-600 border-default-900/10 flex items-start gap-3 border-b border-dashed p-6" style={{ backgroundImage: `url("${settingsBg.src}")` }}>
          <div>
          ...
          <div className="grow">
            <button suppressHydrationWarning type="button" data-hs-overlay="#theme-customization" className="btn btn-sm bg-default-100/20 size-7.5 rounded-full text-white">
        ...
        <div className="border-default-900/10 flex border-t p-5">
          <div className="grid w-full grid-cols-2 gap-4">
            <a href="https://1.envato.market/paces" rel="noopener noreferrer" className="btn py-3 w-full bg-success hover:bg-success-hover text-white">
