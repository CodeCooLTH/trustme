        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Link href="/seller/orders" className="text-sm text-primary hover:underline">ดูทั้งหมด</Link>
            </div>
          </CardHeader>
          <CardContent>
            {orders.length === 0 ? (
              ...
              <div className="space-y-2">
                {orders.map((order: any) => (
                  <Link key={order.id} href={`/seller/orders/${order.publicToken}`} className="block">
