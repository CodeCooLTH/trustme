...
/** SafePay real-data order shape (used by RecentOrder with real props) */
export type SafePayOrderType = {
...
/** SafePay real-data product shape (used by TopSellingProducts with real props) */
export type SafePayProductType = {
  id: string
  name: string
...
/** Paces mock product shape — used by TopSellingProducts (paces default / no prop) */
...
/** Paces mock order shape — used by RecentOrder (paces default / no prop) */
