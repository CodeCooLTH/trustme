...
const feature = [
  ...
  },
  {
    ...
    description: 'ทุกธุรกรรมมีประวัติและรีวิวที่ตรวจสอบได้ สร้างความมั่นใจให้ทั้งผู้ซื้อและผู้ขาย'
  }
]
    ...
    <section id='features' ref={ref} className='bg-backgroundPaper'>
      <div className={classnames('flex flex-col gap-12 pbs-12 pbe-[100px]', frontCommonStyles.layoutSpacing)}>
        <div className='flex flex-col gap-y-4 items-center justify-center'>
          <Chip size='small' variant='tonal' color='primary' label='คุณสมบัติเด่น' />
