      ...
      <div className={classnames('flex flex-col gap-14', frontCommonStyles.layoutSpacing)}>
        <div className='flex flex-col gap-y-4 items-center justify-center'>
          ...
          <div className='flex flex-col items-center gap-y-1 justify-center flex-wrap'>
            ...
            <Typography className='text-center'>มีคำถามหรือข้อเสนอแนะ ส่งข้อความหาเราได้เลย</Typography>
          </div>
        </div>
              ...
              <Card>
                <CardContent>
                  <div className='flex flex-col gap-y-[6px] mbe-6'>
                    <Typography variant='h4'>ส่งข้อความหาเรา</Typography>
                    <Typography>
                      สอบถามเรื่องการใช้งาน แพ็กเกจ การเชื่อมต่อ API หรือความร่วมมือทางธุรกิจ
                      ทีมงานจะตอบกลับภายใน 1 วันทำการ
                    </Typography>
                  </div>
