  ...
  return (
    <div className='flex flex-col gap-6'>
      <div className='flex flex-col justify-center items-center gap-2'>
        <Typography variant='h3'>แพ็กเกจราคา</Typography>
        <div className='flex items-center text-center flex-col  sm:mbe-[3.8rem]'>
          <Typography>
            ทุกแพ็กเกจมาพร้อมฟีเจอร์สร้างความน่าเชื่อถือครบครัน เลือกแพ็กที่เหมาะกับธุรกิจของคุณ
          </Typography>
        </div>
        <div className='flex justify-center items-center relative mbs-0.5'>
          ...
          >
            ...
            />
            <Chip label='ประหยัดสูงสุด 25%' size='small' variant='tonal' color='primary' />
          </div>
        </div>
      </div>
