...
const groups: FaqGroup[] = [
  {
    ...
    subtitle: 'คำถามที่พบบ่อยเกี่ยวกับการใช้งาน SafePay',
    items: [
      {
        id: 'faq-what-is',
        q: 'SafePay คืออะไร?',
        a: 'SafePay เป็นระบบสร้างความน่าเชื่อถือสำหรับการซื้อขายออนไลน์ ผ่านระบบยืนยันตัวตน, Trust Score, Badge และประวัติการซื้อขาย เพื่อช่วยลดปัญหามิจฉาชีพและทำให้ทุกคนซื้อขายออนไลน์ได้อย่างมั่นใจ',
      },
      {
        id: 'faq-is-free',
        q: 'ใช้ฟรีจริงมั้ย?',
      ...
      },
      {
        ...
        a: 'หลังสมัครสมาชิก เข้าไปที่ seller.safepay.co แล้วกดเปิดร้าน กรอกชื่อร้าน ยืนยันตัวตนระดับที่ต้องการ ก็เริ่มสร้าง order ได้ทันที ไม่มีค่าเปิดร้าน',
      },
    ],
  },
  {
